...
--
-- Host: 127.0.0.1
-- Generation Time: May 15, 2017 at 06:44 AM
...
CREATE TABLE `gateways` (
  `id` int(11) UNSIGNED NOT NULL,
  `app_id` varchar(16) NOT NULL DEFAULT '' COMMENT '应用ID',
  `gateway` varchar(16) NOT NULL DEFAULT '' COMMENT '网关',
  `sub` varchar(32) DEFAULT '' COMMENT '子网关',
  `type` enum('wallet','card','telecom') NOT NULL DEFAULT 'wallet' COMMENT '付费类型:钱包 预付卡 运营商',
  `visible` tinyint(3) unsigned NOT NULL DEFAULT '1' COMMENT '支付中心',
  `name` varchar(64) NOT NULL DEFAULT '' COMMENT '名称',
  `remark` varchar(125) DEFAULT '' COMMENT '备注',
  `currency` varchar(32) DEFAULT '' COMMENT '货币',
  `parent` int(10) unsigned DEFAULT '0' COMMENT '父级ID',
...
CREATE TABLE `transactions` (
  ...
  `complete_time` timestamp NULL DEFAULT '0000-00-00 00:00:00' COMMENT '完成时间'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='支付中心';

-- --------------------------------------------------------

--
-- Table structure for table `trans_more`
--
...
ALTER TABLE `transactions`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
--
-- AUTO_INCREMENT for table `trans_more`
--
ALTER TABLE `trans_more`
  MODIFY `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT;
